...
version is 6.2.0. Consumers install anonymously from NuGet.org:

```bash
dotnet add package Noelia.Infrastructure --version 6.2.0
```

Reference only what the service actually runs:

```xml
  <PackageReference Include="Noelia.Infrastructure" Version="6.2.0" />
  <PackageReference Include="Noelia.Redis" Version="6.2.0" />
  <PackageReference Include="Noelia.Data.EntityFrameworkCore" Version="6.2.0" />
```
